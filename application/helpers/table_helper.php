...
{
	$CI =& get_instance();
	$table='<table class="tablesorter table table-striped table-bordered table-hover" id="sortable_table">';
...
function get_people_manage_table_data_rows($people,$controller)
{
	...
	{
		$table_data_rows.="<tr><td><div class='warning_message' style='padding:7px;'>".$CI->lang->line('common_no_persons_to_display')."</div></td></tr>";
	}
...
function get_person_data_row($person,$controller)
{
	...
	$table_data_row='<tr>';
	$table_data_row.="<td width='5%'><input type='checkbox' class='row-checkbox' id='person_$person->person_id' value='".$person->person_id."'/></td>";
